...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new rikaz.tech.bringtoforeground.BringtoforegroundPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin bringtoforeground, rikaz.tech.bringtoforeground.BringtoforegroundPlugin", e);
    }
    try {
